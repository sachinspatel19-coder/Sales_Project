...
Evaluate sales incentives, targets, and achievements
Identify top-performing and non-performing salespeople
...
Renamed and structured columns
Merged multiple tables to create a unified data model
...
Non-Performing Salespeople Analysis
Incentive Comparison (Max, Min, Avg)
Sales Target Funnel & Gauge Dashboard
Region & Gender Analysis
...
Analyzed inventory demand trends for better stock planning
Compared sales targets vs achievements
